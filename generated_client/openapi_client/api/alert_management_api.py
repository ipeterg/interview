...
class AlertManagementApi:
    ...
    def _delete_api_v4_projects_id_alert_management_alerts_alert_iid_metric_images_metric_image_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v4/projects/{id}/alert_management_alerts/{alert_iid}/metric_images/{metric_image_id}',
    ...
    def _get_api_v4_projects_id_alert_management_alerts_alert_iid_metric_images_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v4/projects/{id}/alert_management_alerts/{alert_iid}/metric_images',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_api_v4_projects_id_alert_management_alerts_alert_iid_metric_images_authorize_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v4/projects/{id}/alert_management_alerts/{alert_iid}/metric_images/authorize',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
